...
//     */
//    public TestVision(String vuforiaLicenseKey, LinearOpMode opMode, boolean useVuforiaMonitor,
...
//        telemetry.addData("# Object Detected", pastRecognitions.size());
//
...
//                telemetry.addData("Gold Location:",skystonePositions.toString());
//                int number_of_recognitions = pastRecognitions.size();
//                telemetry.addData("# Object Detected", number_of_recognitions);
...
//                    telemetry.addData("Found", idLabel);
//                    telemetry.addData("Mineral distance to target", closestDetectionDistance);
//                } else {
//                    telemetry.addData("No Mineral Detected in target location", "");
//                }
//
//            }
//
